...
CREATE TABLE mst.challenge_data (
    ...
    CONSTRAINT challenge_data_ukey UNIQUE (challenge_id)
);

CREATE INDEX challenge_event_created_at_idx ON mst.challenge_data (event_created_at);
CREATE INDEX challenge_event_occurred_at_idx ON mst.challenge_data (event_occurred_at);
