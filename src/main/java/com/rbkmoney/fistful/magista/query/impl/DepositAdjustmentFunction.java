...
public class DepositAdjustmentFunction extends PagedBaseFunction<Map.Entry<Long, StatDepositAdjustment>, StatResponse>
        implements CompositeQuery<Map.Entry<Long, StatDepositAdjustment>, StatResponse> {
    ...
    public static DepositAdjustmentFunction createFunction(
            Object descriptor, QueryParameters queryParameters,
            String continuationToken,
            CompositeQuery<QueryResult, List<QueryResult>> subquery) {
        DepositAdjustmentFunction func = new DepositAdjustmentFunction(
                descriptor,
                queryParameters,
                continuationToken,
                subquery);
    ...
    private DepositAdjustmentFunction(
            Object descriptor,
    ...
    @Override
    public QueryResult<Map.Entry<Long, StatDepositAdjustment>, StatResponse> execute(QueryContext context)
    ...
    @Override
    public QueryResult<Map.Entry<Long, StatDepositAdjustment>, StatResponse> execute(
            QueryContext context,
            List<QueryResult> collectedResults) throws QueryExecutionException {
        var queryResult = (QueryResult<Map.Entry<Long, StatDepositAdjustment>,
                List<Map.Entry<Long, StatDepositAdjustment>>>) collectedResults.get(0);
        ...
        return new BaseQueryResult<>(
                ...
                () -> {
                    ...
                    StatResponse statResponse =
                            new StatResponse(StatResponseData.deposit_adjustments(depositAdjustments));
